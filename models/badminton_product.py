...
class BadmintonProduct(models.Model):
    ...
    stock_movement_ids = fields.One2many('badminton.stock.movement', 'product_id', string="Stok Hərəkətləri")
    ...
    sale_line_ids = fields.One2many('badminton.product.sale.line', 'product_id', string="Satışlar")
