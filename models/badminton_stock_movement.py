...
class BadmintonStockMovement(models.Model):
    _name = 'badminton.stock.movement'
    _description = 'Badminton Stok Hərəkəti'
    _order = 'movement_date desc, id desc'
    
    product_id = fields.Many2one('badminton.product', string="Məhsul", required=True, ondelete='cascade')
    ...
    def create(self, vals):
        ...
        product = self.env['badminton.product'].browse(vals['product_id'])
